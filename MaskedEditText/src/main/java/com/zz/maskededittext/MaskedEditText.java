...
import com.zz.maskededittext.R;
...
//					return false;
    ...
    private boolean maskHint;
    private int[] rawToMask;
    private com.zz.maskededittext.RawText rawText;
    ...
    public MaskedEditText(Context context, AttributeSet attrs) {
        ...
        maskHint = attributes.getBoolean(R.styleable.MaskedEditText_mask_hint, false);
...
//		if (text == null || text.equals("")) return;
    ...
    private void cleanUp() {
        ...
        if (!shouldKeepText || rawText == null) {
            rawText = new com.zz.maskededittext.RawText();
        ...
        super.setOnFocusChangeListener(new OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                if (hasFocus()) {
                    ...
                    if (text != null && text.length() > lastValidPosition()) {
